...
typedef struct {
	...
	qhandle_t	greenCubeModel;
	qhandle_t	redCubeIcon;
	qhandle_t	blueCubeIcon;
	qhandle_t	greenCubeIcon;
#endif
	...
	sfxHandle_t yourTeamTookEnemyFlagsSound;
	sfxHandle_t	youHaveFlagSound;
#ifdef MISSIONPACK
	sfxHandle_t	enemyTookTheFlagSound;
	sfxHandle_t yourTeamTookTheFlagSound;
	sfxHandle_t yourTeamTookTheFlagsSound;
...
typedef struct {
	...
	int				redflag, blueflag, greenflag;		// flag status from configstrings
	int				flagStatus;
...
qboolean CG_YourTeamHasFlags( void );
