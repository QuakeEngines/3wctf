...
static int gametype_remap[] = {GT_FFA, GT_TEAM, GT_TOURNAMENT, GT_CTF, GT_3WCTF
#ifdef MISSIONPACK
,GT_1FCTF, GT_OBELISK, GT_HARVESTER
#endif
};
static int gametype_remap2[] = {0, 2, 4, 1, 3
#ifdef MISSIONPACK
,5, 6, 7
#endif
};
...
static void ServerOptions_Start( void ) {
	...
	case GT_3WCTF:
		trap_Cvar_SetValue( "ui_3wctf_capturelimit", flaglimit );
		trap_Cvar_SetValue( "ui_3wctf_timelimit", timelimit );
		trap_Cvar_SetValue( "ui_3wctf_friendly", friendlyfire );
		break;
...
static void ServerOptions_SetMenuItems( void ) {
	...
	case GT_3WCTF:
		MField_SetText( &s_serveroptions.flaglimit.field, va( "%i", (int)Com_Clamp( 0, 100, trap_Cvar_VariableValue( "ui_3wctf_capturelimit" ) ) ) );
		MField_SetText( &s_serveroptions.timelimit.field, va( "%i", (int)Com_Clamp( 0, 999, trap_Cvar_VariableValue( "ui_3wctf_timelimit" ) ) ) );
		s_serveroptions.friendlyfire.curvalue = (int)Com_Clamp( 0, 1, trap_Cvar_VariableValue( "ui_3wctf_friendly" ) );
		break;
